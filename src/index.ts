...
app.get("/inventory/:id", async (req: Request, res: Response, next: NextFunction) => {
  const { id } = req.params;
  try {
...
app.post("/inventory", async (req: Request, res: Response, next: NextFunction) => {
...
app.put("/inventory/:_id", async (req: Request, res: Response, next: NextFunction) => {
...
app.delete("/inventory/:id", async (req: Request, res: Response, next: NextFunction) => {
  const { id } = req.params;
  try {
